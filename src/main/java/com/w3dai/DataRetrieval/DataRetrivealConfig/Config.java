package com.w3dai.DataRetrieval.DataRetrivealConfig;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.w3dai.DataRetrieval.Entity")
@ComponentScan(basePackages = { "com.w3dai"})
public class Config {
    @Value("C:\\elasticsearch\\6.5.3")
